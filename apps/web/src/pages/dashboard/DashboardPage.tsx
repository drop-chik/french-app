    ...
    <div className={styles.page}>
      ...
      <div className={styles.progressCard}>
        ...
        <div className={styles.progressMeta}>
          <span>{t.dashboard.masteredWords.replace('{n}', String(lp.learnedWords ?? lp.masteredWords))} / {lp.targetWords ?? lp.totalWords}</span>
...
function LevelItem({ lv }: { lv: LevelProgressData }) {
  ...
  return (
    <div className={styles.levelItem}>
      ...
      <span className={styles.levelMeta}>{lv.learnedWords} / {lv.targetWords ?? lv.totalWords}</span>
    </div>
  );
}
